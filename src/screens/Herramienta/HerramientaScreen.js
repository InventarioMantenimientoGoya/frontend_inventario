...
const rawItemData = [
  { fechaentrada: '01/04/2025', id: '', Her_categoria: 'Mecánico', Her_nombre: 'HOMBRE SOLO', Her_caracteristica1: '10"', Her_caracteristica2: '', descripcion: '', Her_marca: '', Her_ubicacion: 'HE01', Her_stock: '1', Her_unidad_medida: 'UNIDADES', Her_observaciones: 'REQUISICIÓN', fechadevolucion: '--'},
  { fechaentrada: '02/04/2025', id: '', Her_categoria: 'Mecánico', Her_nombre: 'TALADRO', Her_caracteristica1: '3/8"', Her_caracteristica2: '', descripcion: '', Her_marca: '', Her_ubicacion:'HE01', Her_stock: '1', Her_unidad_medida: 'UNIDADES', Her_observaciones: 'REQUISICIÓN', fechadevolucion: '--'},
  { fechaentrada: '03/04/2025', id: '', Her_categoria: 'Mecánico', Her_nombre: 'BROCA', Her_caracteristica1: '1/4"', Her_caracteristica2: '', descripcion: '', Her_marca: '', Her_ubicacion: 'HE01', Her_stock:'1', Her_unidad_medida: 'UNIDADES', Her_observaciones: 'REQUISICIÓN', fechadevolucion: '--'},
  { fechaentrada: '04/04/2025', id: '', Her_categoria: 'Eléctrico', Her_nombre: 'MULTIMETRO', Her_caracteristica1: 'UT33C+', Her_caracteristica2: '', descripcion: '', Her_marca: '', Her_ubicacion: 'HE01', Her_stock: '1', Her_unidad_medida: 'UNIDADES', Her_observaciones: 'REQUISICIÓN', fechadevolucion: '--'},
  { fechaentrada: '05/04/2025', id: '', Her_categoria: 'Eléctrico', Her_nombre: 'PINZA PERIMETRICA', Her_caracteristica1: '', Her_caracteristica2: '', descripcion: '', Her_marca: '', Her_ubicacion: 'HE01', Her_stock: '1', Her_unidad_medida: 'UNIDADES', Her_observaciones: 'REQUISICIÓN', fechadevolucion: '--'},
  { fechaentrada: '06/04/2025', id: '', Her_categoria: 'Mecánico', Her_nombre: 'LLAVE', Her_caracteristica1: '12mm', Her_caracteristica2: '', descripcion: '', Her_marca: '', Her_ubicacion: 'HE01', Her_stock:'1', Her_unidad_medida: 'UNIDADES', Her_observaciones: 'REQUISICIÓN', fechadevolucion: '--'},
  { fechaentrada: '07/04/2025', id: '', Her_categoria: 'Mecánico', Her_nombre: 'FLEXOMETRO', Her_caracteristica1: '5 mts', Her_caracteristica2: '', descripcion: '', Her_marca: '', Her_ubicacion: 'HE01', Her_stock:'1', Her_unidad_medida: 'UNIDADES', Her_observaciones: 'REQUISICIÓN', fechadevolucion: '--'},
  { fechaentrada: '08/04/2025', id: '', Her_categoria: 'Mecánico', Her_nombre: 'MARTILLO', Her_caracteristica1: '', Her_caracteristica2: '', descripcion: '', Her_marca: '', Her_ubicacion: 'HE01', Her_stock:'1', Her_unidad_medida: 'UNIDADES', Her_observaciones: 'REQUISICIÓN', fechadevolucion: '--'},
];
...
const ItemScreen = () => {
  ...
  const [itemStatus, setItemStatus] = useState(itemData.map(() => 'Devuelto'));
  ...
  const handleStatusChange = (index) => {
    if (typeof window !== "undefined" && window.confirm) {
      const newStatus = itemStatus[index] === 'Devuelto' ? 'En Prestamo' : 'Devuelto';
      const confirmChange = window.confirm(`¿Estás seguro que deseas cambiar el estado a "${newStatus}"?`);
      if (confirmChange) {
      ...
      Alert.alert(
        ...
        `¿Estás seguro que deseas cambiar el estado a "${itemStatus[index] === 'Devuelto' ? 'En Prestamo' : 'Devuelto'}"?`,
        [
          {
            text: 'Cancelar',
            style: 'cancel',
          },
          {
            ...
            onPress: () => {
              setItemStatus((prevStatus) => {
                ...
                newStatus[index] = newStatus[index] === 'Devuelto' ? 'En Prestamo' : 'Devuelto';
                return newStatus;
              });
            },
          },
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      ...
      <View style={styles.container}>
        <Image
          ...
          resizeMode="contain"
        />
        <Text style={styles.title}>HISTORIAL PRESTAMOS</Text>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={true}>
            <View>
              <View style={styles.tableHeader}>
                <Text style={styles.th}>FECHA DE SALIDA</Text>
                ...
                <Text style={styles.th}>FECHA DE DEVOLUCION</Text>
              ...
              <ScrollView style={styles.tableBody} showsVerticalScrollIndicator={true}>
                {filteredData.map((item, index) => (
                  <View style={styles.row} key={index}>
                    ...
                    <Text style={styles.td}>{item.fechadevolucion}</Text>
                    <Text style={styles.td}>{item.imagen}</Text>
                    <TouchableOpacity
                      style={[styles.statusButton, { backgroundColor: itemStatus[index] === 'Devuelto' ? 'green' : 'orange' }]}
                      onPress={() => handleStatusChange(index)}
                    >
                      <Text style={styles.statusButtonText}>{itemStatus[index]}</Text>
                    </TouchableOpacity>
                  </View>
                ))}
              </ScrollView>
