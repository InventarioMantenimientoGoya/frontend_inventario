      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            {/* Botón de acción para confirmar cierre */}
            {/* Botones de acción: Confirmar y Cancelar */}
            <View style={[styles.buttonContainer, isLargeScreen && styles.buttonContainerRow]}>
              <Pressable
                style={[styles.buttonModal, isLargeScreen && styles.buttonHalf]}
...
const styles = StyleSheet.create({
  ...
  buttonContainerRow: {
    ...
    alignItems: 'center', // ✅ evita que los botones se estiren en altura
  },
  buttonHalf: {
    width: '48%',
    marginTop: 0,
