...
const CorreoRecuperacion = () => {
    ...
    const [isModalEnviadoVisible, setIsModalEnviadoVisible] = useState(false);
    ...
    const handleEnviar = async () => {
        try {
            ...
            if (usuarioEncontrado) {
                ...
                } else if (correoEnviado.status === 220) {
                    setIsModalEnviadoVisible(true);
                }
            } else {
        ...
        >
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        {/* Título del modal */}
                        <Text style={styles.titleModal}>¡EL CORREO YA FUE ENVIADO!</Text>
                        {/* Descripción del modal */}
                        <Text style={styles.descriptionModal}>Ya se ha enviado un correo con el enlace de recuperación. Este enlace solo puede utilizarse una vez.</Text>
                        {/* Logo Decorativo */}
                        <Image
                            source={require('../../../assets/img/logo.png')}
                            style={styles.logoModal}
                        ...
                        <Pressable
                            style={styles.buttonModal}
                            onPress={() => setIsModalEnviadoVisible(false)}
                        >
                            <Text style={styles.buttonModalText}>Aceptar</Text>
                        </Pressable>
                    </View>
